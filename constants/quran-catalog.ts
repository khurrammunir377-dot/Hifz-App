export type SurahCatalogItem = {
  number: number;
  name: string;
  ayahCount: number;
};

// Structural metadata only. Quran text will be supplied by a separately verified
// Uthmani-script repository in the governed Quran data phase.
export const SURAHS: SurahCatalogItem[] = [
